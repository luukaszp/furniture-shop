...
<div class="container">
    ...
    <hr>
    <h3 class="pt-3" style="font-weight: bold; text-align: center">Czas dostawy</h3>
    ...
    <h3 class="pt-3" style="font-weight: bold; text-align: center">Koszty dostawy</h3>
    ...
    <p>Gdy przesyłka w całości wyniesie <span style="font-weight: bold"> powyżej 500 zł </span>, dostawa jest <span style="font-weight: bold"> darmowa </span>. <span style="font-weight: bold"> Za dopłatą 30 zł </span>, istnieje możliwość wniesienia przesyłki do mieszkania przez kuriera.</p>
</div>
@endsection
