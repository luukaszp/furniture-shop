...
@section('content')
<div class="container">
    <h1 class="pb-3" style="text-align: center">Formy płatności</h1>
    <h3>Płatność kartą</h3>
    <p>Po zakupie mebli, strona automatycznie przekierowywuje na zakładkę z płatnościami. Wystarczy uzupełnić formularz danymi z karty.</p>
    <h3>Przelew</h3>
