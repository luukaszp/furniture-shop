...
<div class="container">
    ...
    <h3>Polityka prywatności serwisu SKLEP MEBLOWY</h3>
    ...
    <p>4. Dane Osobowe przetwarzane są na podstawie zgody wyrażanej przez Użytkownika oraz
    ...
    <p>5. Serwis realizuje funkcje pozyskiwania informacji o użytkownikach i ich zachowaniach w
    następujący sposób:
    ...
    <p>7. Dane podane w formularzu są przetwarzane w celu wynikającym z funkcji konkretnego
    formularza np. w celu dokonania procesu obsługi kontaktu informacyjnego</p>

    <p>8. Dane osobowe pozostawione w serwisie nie zostaną sprzedane ani udostępnione
    osobom trzecim, zgodnie z przepisami Ustawy o ochronie danych osobowych.</p>

    <p>9. Do danych zawartych w formularzu przysługuje wgląd osobie fizycznej, która je tam
    umieściła. Osoba ta ma również praw do modyfikacji i zaprzestania przetwarzania swoich
    danych w dowolnym momencie.</p>

    <p>10. Zastrzegamy sobie prawo do zmiany w polityce ochrony prywatności serwisu, na które
    ...
    <p>11. W Serwisie mogą pojawiać się linki do innych stron internetowych. Takie strony
